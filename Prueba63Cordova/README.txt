...
a persistence unit "Prueba63CordovaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Prueba63Cordova/pom.xml":
...
artifact ("Prueba63Cordova.war") is already built. You can build
